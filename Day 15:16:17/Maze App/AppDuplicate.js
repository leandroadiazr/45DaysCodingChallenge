...
const height = 780;
const cells = 10;
let numR_C = 15; //always needs to be bigger than cells
...
horizontals.forEach((row, rowIdx) => {
	row.forEach((open, columnIdx) => {
		...
		const wall = Bodies.rectangle(
			columnIdx * unitLenght + unitLenght / 2,
			rowIdx * unitLenght + unitLenght,
			unitLenght,
			numR_C,
			{
				label: "wall",
...
verticals.forEach((row, rowIdx) => {
	row.forEach((open, columnIdx) => {
		...
		const wall = Bodies.rectangle(
			columnIdx * unitLenght + unitLenght,
			rowIdx * unitLenght + unitLenght / 2,
			numR_C,
			unitLenght,
			{
				label: "wall",
...
const ball = Bodies.circle(
	unitLenght / 2, //x coordinate
	unitLenght / 2, //y coordinate
	unitLenght * 0.3,
	{
		label: "ball"
	}
